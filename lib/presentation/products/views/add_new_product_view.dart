                        ...
                        child: pickedImage.path.isNotEmpty
                            ? Padding(
                                ...
                                child: Row(
                                  children: [
                                    Text(
                                      pickedImage.name.length > 35
                                          ? "${pickedImage.name.substring(0, 35)}..."
                                          : pickedImage.name,
                                        ...
                                        showDialog(
                                          ...
                                          builder: (BuildContext context) => AlertDialog(
                                            ...
                                            content: SingleChildScrollView(
                                              child: ListBody(
                                                children: <Widget>[
                                                  Image.asset(Strings.deleteEmoji, width: 50, height: 50),
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        Navigator.pushNamed(
                                          context,
                                          ImagePreview.id,
                                          arguments: ImagePreviewArguments(image: pickedImage.path),
                                        );
                                      },
                                      child: Text(
                                        'View',
